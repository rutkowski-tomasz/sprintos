...
export function Logo({ size = 28 }: { size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path
        d="M303,92 Q310,68 290,87 L114,257 Q94,276 126,276 L213,276 Q245,276 236,299 L184,421 Q175,444 197,426 L396,254 Q418,236 386,236 L299,236 Q267,236 274,213 Z"
        fill="#a855f7" filter={`url(#${glow})`} opacity={0.7}
      />
      <path
        d="M303,92 Q310,68 290,87 L114,257 Q94,276 126,276 L213,276 Q245,276 236,299 L184,421 Q175,444 197,426 L396,254 Q418,236 386,236 L299,236 Q267,236 274,213 Z"
        fill={`url(#${gm})`}
      ...
      />
      <path
        d="M303,92 Q310,68 290,87 L114,257 Q94,276 126,276 L129,276"
        fill="none" stroke="rgba(255,255,255,0.55)" strokeWidth={5} strokeLinecap="round"
      />
      <path
        d="M299,236 Q267,236 274,213"
